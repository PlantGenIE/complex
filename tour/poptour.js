(function(context, namespace) {
  ...
  HopscotchBubble.prototype = {
    ...
    setContent: function(contentStr) {
		 var species_1=$("#sp_1 option:selected").text();
		 var species_2=$("#sp_2 option:selected").text();
		 
		if(contentStr=="sp1i"){ contentStr="Input "+species_1+" genes here";}
		if(contentStr=="sp2i") {contentStr="Input "+species_2+" genes here";}
		if(contentStr=="align2") {contentStr="Align the input genes of "+species_1+" to all genes of "+species_2+" for selected thresholds.";}	
		if(contentStr=="compare2") {contentStr="Compare the input genes of "+species_1+" with input genes of "+species_2+" for selected thresholds.";}
		if(contentStr=="firstn") {contentStr="Network of "+species_1+" genes (nodes) and correlations (edges). To add co expressed genes, rightclick on one or several genes in the display and choose add co-expressed genes.";}	
		if(contentStr=="secondn") {contentStr="Network of "+species_2+" genes (nodes) and correlations (edges). To add co expressed genes, rightclick on one or several genes in the display and choose add co-expressed genes.";}		 
		 
		 if(contentStr=="infomrtaion") {contentStr="Information about "+species_1+"  and "+species_2+" networks.";}
		 if(contentStr=="replaceb") {contentStr="Click here to replace selected genes with  "+species_1+"  and "+species_2+" GeneLists.";}
 		 if(contentStr=="sendb") {contentStr="Click here to send selected genes into  "+species_1+"  and "+species_2+" GeneLists.";}
 		
		
		 if(contentStr=="firsttableg") {contentStr="Here are the list of genes related to "+species_1+"  network. It's possible to select or filter our favourite genes for further analysis.";}
		 if(contentStr=="secondtableg") {contentStr="Here are the list of genes related to "+species_2+"  network. It's possible to select or filter our favourite genes for further analysis.";}
