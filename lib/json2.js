...
<meta content="+1QF5UJ+1z4wwbYLmmEoGVJoq+N1SxOMNzgfs8MVmyo=" name="csrf-token" />
  ...
  <input type="text" name="q" id="command-bar" placeholder="Search or type a command" tabindex="1" data-username="grokkaine" autocapitalize="off">
  ...
  <div class="divider-vertical"></div>
    ...
    <ul id="user-links">
      <li>
        <a href="https://github.com/grokkaine" class="name">
          <img height="20" src="https://secure.gravatar.com/avatar/2519e776a31d4b2b4f69521758f61906?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="20" /> grokkaine
        </a>
      </li>
      <li>
      ...
      <div class="hentry">
        ...
        <div class="pagehead repohead instapaper_ignore readability-menu">
          ...
          <li class="subscription">
              <form accept-charset="UTF-8" action="/notifications/subscribe" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="+1QF5UJ+1z4wwbYLmmEoGVJoq+N1SxOMNzgfs8MVmyo=" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="1092277" />
      ...
      <div class="context-body pane-selector">
        <ul class="js-navigation-container">
          ...
          <li class="js-toggler-container js-social-container starring-container ">
            ...
            </a><a class="social-count js-social-count" href="/douglascrockford/JSON-js/stargazers">2,765</a>
          </li>

              <li><a href="/douglascrockford/JSON-js/fork" class="minibutton js-toggler-target fork-button lighter" rel="nofollow" data-method="post"><span class="mini-icon mini-icon-fork"></span>Fork</a><a href="/douglascrockford/JSON-js/network" class="social-count">879</a>
              </li>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.08433s from fe17.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
...
`&lt;addr&gt;` element here instead.</pre>
    ...
    <span id='server_response_time' data-time='0.08579' data-host='fe17'></span>
